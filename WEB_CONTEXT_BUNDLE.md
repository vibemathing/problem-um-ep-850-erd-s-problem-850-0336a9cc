...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-850-erd-s-problem-850-0336a9cc-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-850"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-850-erd-s-problem-850-0336a9cc-v1",
      "problem_contract_sha256": "b3f352c74656db2625b0bca823313fedd776c4181e47e25876ff9db9e6862f35",
      "problem_id": "problem:um-ep-850-erd-s-problem-850-0336a9cc",
      "route_id": "route:um-ep-850-erd-s-problem-850-0336a9cc-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-850-erd-s-problem-850-0336a9cc-source-fidelity-01",
      "graph_id": "graph:um-ep-850-erd-s-problem-850-0336a9cc-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-850-erd-s-problem-850-0336a9cc-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-850-erd-s-problem-850-0336a9cc-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Can there exist two distinct integers $x$ and $y$ such that $x,y$ have the same prime factors, $x+1,y+1$ have the same prime factors, and $x+2,y+2$ also have the same prime factors?"
          },
          "statement_sha256": "bd2385c56db0686b871b751836f5c5ce7544dbe071d6a617ce323831c027e95e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-850-erd-s-problem-850-0336a9cc-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-850-erd-s-problem-850-0336a9cc-root",
      "route_id": "route:um-ep-850-erd-s-problem-850-0336a9cc-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-850-00773228a319",
        "url": "https://www.unsolvedmath.com/problems/EP-850"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
